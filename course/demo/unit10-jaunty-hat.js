...
function setupGui() {
  ...
  gui
    .add(effectController, 'useQuaternion')
  ...
  gui
    .add(effectController, 'goAtAnAngle')
    .name('hat axis angled')
    .onChange(function () {
      TWEEN.removeAll()
      setTweens()
      traceQuat.clear()
  ...
  gui
    .add(effectController, 'forwardHatAngle', 0.0, 90.0, 1.0)
    .name('forward angle')
    .onChange(function () {
      TWEEN.removeAll()
      setTweens()
  ...
  gui
    .add(effectController, 'backwardHatAngle', 0.0, 90.0, 1.0)
    .name('backward angle')
    .onChange(function () {
      TWEEN.removeAll()
      setTweens()
  ...
  gui
    .add(effectController, 'useBodyRotation')
    .name('animate bird')
    .onChange(function () {
  ...
  gui
    .add(effectController, 'shadowDarkness', 0.0, 1.0, 0.1)
  ...
  gui
    .add(effectController, 'showTraces')
    .name('show traces')
    .onChange(function () {
      traceQuat.clear()
      traceEuler.clear()
