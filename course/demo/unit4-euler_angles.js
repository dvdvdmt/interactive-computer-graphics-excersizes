...
function fillScene() {
  ...
  var sphere = new THREE.Mesh(new THREE.SphereGeometry(15, 32, 16), planeMaterial)
  // nose
  ...
  var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(15, 15, 180, 32), planeMaterial)
  // body
  ...
  cylinder = new THREE.Mesh(new THREE.CylinderGeometry(20, 20, 250, 32), planeMaterial)
  // wing
  ...
  cylinder = new THREE.Mesh(new THREE.CylinderGeometry(15, 15, 100, 32), planeMaterial)
  // tail wing
  cylinder.scale.x = 0.2
  cylinder.rotation.z = (90 * Math.PI) / 180
  cylinder.position.y = 5
  ...
  cylinder = new THREE.Mesh(new THREE.CylinderGeometry(10, 15, 40, 32), planeMaterial)
  // tail
...
function createRing(radius, color, axis) {
  ...
  //create ring shape
  var circleMesh = new THREE.Mesh(new THREE.TorusGeometry(radius, 5, 6, 50), ringMaterial)

  var sphereMesh = new THREE.Mesh(new THREE.SphereGeometry(sphere_radius, 12, 10), ringMaterial)
...
function render() {
  ...
  if (
    ...
    effectController.newRings !== rings
  ) {
