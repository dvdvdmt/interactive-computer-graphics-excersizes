...
function setFilters() {
  ...
  for (var name in texture) {
    if (texture.hasOwnProperty(name)) {
      ...
      texture[name].wrapS = wrapVal
      texture[name].wrapT = wrapVal
...
function init() {
  ...
  texture['checker 1x1 (gray)'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker1x1.png'
  )
  texture['checker 2x2'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker2x2.png'
  )
  texture['checker 4x4'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker4x4.png'
  )
  texture['checker 8x8'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker8x8.png'
  )
  texture['checker 16x16'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker16x16.png'
  )
  texture['checker 32x32'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker32x32.png'
  )
  texture['checker 64x64'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker64x64.png'
  )
  texture['checker 128x128'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker128x128.png'
  )
  texture['checker 256x256'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker256x256.png'
  )
  texture['checker 512x512'] = THREE.ImageUtils.loadTexture(
    path + 'media/img/cs291/textures/checker512x512.png'
  )
  ...
  for (var name in texture) {
    if (texture.hasOwnProperty(name)) {
      material[name] = new THREE.MeshBasicMaterial({
        map: texture[name],
...
function render() {
  ...
  if (refill || mtlName !== effectController.mtlName) {
