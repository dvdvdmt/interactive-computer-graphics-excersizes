...
function fillScene() {
  ...
  var stamen = new THREE.Mesh(new THREE.SphereGeometry(20, 32, 16), stamenMaterial)
  stamen.position.y = flowerHeight // move to flower center
  flower.add(stamen)

  var stemMaterial = new THREE.MeshLambertMaterial({color: 0x339424})
  var stem = new THREE.Mesh(new THREE.CylinderGeometry(10, 10, flowerHeight, 32), stemMaterial)
