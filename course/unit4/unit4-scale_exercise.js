...
function fillScene() {
  ...
  // clock
  var clock = new THREE.Mesh(new THREE.CylinderGeometry(75, 75, 10, 32), faceMaterial)
  //new THREE.CubeGeometry( 150, 5, 150 ), faceMaterial );
  clock.position.y = 5
  scene.add(clock)

  // marks
  var cube = new THREE.Mesh(new THREE.CubeGeometry(20, 4, 15), mark12Material)
  cube.position.x = 60
  cube.position.y = 9
  scene.add(cube)

  cube = new THREE.Mesh(new THREE.CubeGeometry(10, 4, 10), markMaterial)
  cube.position.x = -60
  cube.position.y = 9
  scene.add(cube)
  ...
  cube = new THREE.Mesh(new THREE.CubeGeometry(110, 4, 4), minuteHandMaterial)
  cube.position.y = 14
  cube.rotation.y = (-60 * Math.PI) / 180

  scene.add(cube)

  var sphere = new THREE.Mesh(new THREE.SphereGeometry(10, 32, 16), hourHandMaterial)
  sphere.position.y = 18 // move the hand above the other hand
  sphere.scale.x = 3
  sphere.scale.y = 0.2
  sphere.scale.z = 0.2
  sphere.rotation.y = (24 * Math.PI) / 180
  // YOUR CODE HERE:
