...
function fillScene() {
  ...
  var sphere = new THREE.Mesh(new THREE.SphereGeometry(20, 32, 16), snowMaterial)
  sphere.position.y = 20
  scene.add(sphere)

  sphere = new THREE.Mesh(new THREE.SphereGeometry(15, 32, 16), snowMaterial)
  sphere.position.y = 50
  scene.add(sphere)

  sphere = new THREE.Mesh(new THREE.SphereGeometry(10, 32, 16), snowMaterial)
  sphere.position.y = 70
  scene.add(sphere)

  var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(2, 2, 60, 32), woodMaterial)
