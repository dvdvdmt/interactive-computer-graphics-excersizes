...
function createBody(bbody) {
  ...
  var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(104 / 2, 104 / 2, 0, 32), bodyMaterial)
...
function createHead(bhead) {
  ...
  // head
  var sphere = new THREE.Mesh(new THREE.SphereGeometry(104 / 2, 32, 16), headMaterial)
  sphere.position.x = 0
  ...
  // hat
  var cylinder = new THREE.Mesh(new THREE.CylinderGeometry(142 / 2, 142 / 2, 10, 32), hatMaterial)
  cylinder.position.x = 0
